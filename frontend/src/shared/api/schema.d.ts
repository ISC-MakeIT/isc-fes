...
export interface paths {
  ...
  "/stores/{store_id}/toppings/{topping_id}": {
    ...
    head?: never;
    /** 店舗のトッピングを更新する */
    patch: operations["updateToppingByStoreIDAndToppingID"];
    trace?: never;
  };
  ...
  "/store-invitations/{invitation_id}/accept": {
    ...
    put?: never;
    /** 店舗のメンバー招待を受け入れる */
    post: operations["acceptStoreInvitation"];
    delete?: never;
    options?: never;
    head?: never;
    patch?: never;
...
export interface operations {
  ...
  removeStoreMember: {
    ...
    responses: {
      ...
      /** @description 権限不足（自分が店舗管理者ではない、対象が店舗管理者である） */
      403: {
        headers: {
          [name: string]: unknown;
        };
  ...
  createTopping: {
    ...
    requestBody: {
      content: {
        "application/json": components["schemas"]["CreateToppingInput"];
      };
    };
    responses: {
      /** @description 店舗のトッピングを作成した */
      201: {
        headers: {
          [name: string]: unknown;
        };
  ...
  deleteToppingByStoreIDAndToppingID: {
    parameters: {
      query?: never;
      header?: never;
      path: {
    ...
    responses: {
      ...
      /** @description 店舗が存在しない（未承認の店舗はトッピングを削除できない）、またはトッピングが存在しない */
      404: {
        headers: {
          [name: string]: unknown;
        };
  ...
  acceptStoreInvitation: {
    ...
    requestBody?: never;
    responses: {
      /** @description 店舗のメンバー招待を受け入れた */
      201: {
        headers: {
          [name: string]: unknown;
        };
        content: {
          "application/json": components["schemas"]["AcceptStoreInvitationResponse"];
        };
      };
      /** @description リクエスト形式が不正 */
      400: {
      ...
      /** @description 招待が存在しない、使用回数が上限に達している */
      404: {
        headers: {
          [name: string]: unknown;
        };
